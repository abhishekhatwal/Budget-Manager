...
public class today_activity extends AppCompatActivity {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists() && snapshot.getChildrenCount()>0) {
                    for (DataSnapshot snap : snapshot.getChildren()) {
                        ...
                        String sTotal = String.valueOf("total spending of today: $" + totalAmount);
                        budgetheading.setText(sTotal);
                    }
                }
                else
                    budgetheading.setText("total spending of today is $0");
            }
    ...
    public void add()
    {
        AlertDialog.Builder mydialog=new AlertDialog.Builder(today_activity.this);
        LayoutInflater inflater=LayoutInflater.from(today_activity.this);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(budgetamt))
                    Toast.makeText(today_activity.this,"select budget amount",Toast.LENGTH_SHORT).show();
                if(budgetitm.equals("select item"))
                    Toast.makeText(today_activity.this,"select valid item",Toast.LENGTH_SHORT).show();
